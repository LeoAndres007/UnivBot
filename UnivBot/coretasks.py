# coding=utf8
"""
coretasks.py - UnivBot Routine Core tasks
...
UnivBot: http://UnivBot.dftba.net/
...
import time
import UnivBot
from UnivBot.tools import Nick, iteritems
import base64


@UnivBot.module.event('251')
@UnivBot.module.rule('.*')
@UnivBot.module.thread(False)
@UnivBot.module.unblockable
...
@UnivBot.module.event('477')
@UnivBot.module.rule('.*')
@UnivBot.module.priority('high')
...
#Functions to maintain a list of chanops in all of UnivBot's channels.


@UnivBot.module.rule('(.*)')
@UnivBot.module.event('353')
@UnivBot.module.priority('high')
@UnivBot.module.thread(False)
@UnivBot.module.unblockable
def handle_names(bot, trigger):
    ...
    # it'd be worth it.
    mapping = {'+': UnivBot.module.VOICE,
               '%': UnivBot.module.HALFOP,
               '@': UnivBot.module.OP,
               '&': UnivBot.module.ADMIN,
               '~': UnivBot.module.OWNER}
...
def track_modes(bot, trigger):
    ...
    mapping = {'v': UnivBot.module.VOICE,
               'h': UnivBot.module.HALFOP,
               'o': UnivBot.module.OP,
               'a': UnivBot.module.ADMIN,
               'q': UnivBot.module.OWNER}
...
@UnivBot.module.event('AUTHENTICATE')
@UnivBot.module.rule('.*')
...
@UnivBot.module.commands('blocks')
@UnivBot.module.priority('low')
@UnivBot.module.thread(False)
@UnivBot.module.unblockable
def blocks(bot, trigger):
    """Manage UnivBot's blocking features.

    https://github.com/embolalia/UnivBot/wiki/Making-UnivBot-ignore-people
    ...
    STRINGS = {
        ...
        "invalid": "Invalid format for %s a block. Try: .blocks add (nick|hostmask) UnivBot",
