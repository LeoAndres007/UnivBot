# coding=utf8
"""
reload.py - UnivBot Module Reloader Module
...
@UnivBot.module.nickname_commands("reload")
...
def f_reload(bot, trigger):
    ...
    # Also remove all references to UnivBot callables from top level of the
...
@UnivBot.module.nickname_commands('update')
...
@UnivBot.module.nickname_commands("load")
@UnivBot.module.priority("low")
@UnivBot.module.thread(False)
...
@UnivBot.module.commands("reload")
@UnivBot.module.priority("low")
@UnivBot.module.thread(False)
...
@UnivBot.module.commands('update')
