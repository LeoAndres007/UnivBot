# coding=utf8
"""
github.py - UnivBot Github Module
...
from UnivBot.module import commands, rule, NOLIMIT
import os
import re
...
def configure(config):
    ...
    | repo | embolalia/UnivBot | The GitHub repo you're working from. |
    """
    chunk = ''
    if config.option('Configuring github issue reporting and searching module', False):
        ...
        config.interactive_add('github', 'repo', 'Github repository', 'embolalia/UnivBot')
    return chunk
