# coding=utf8
"""
remind.py - UnivBot Reminder Module
...
def dump_database(name, data):
    ...
    for unixtime, reminders in UnivBot.tools.iteritems(data):
...
def remind(bot, trigger):
    ...
    timezone = UnivBot.tools.get_timezone(
...
def at(bot, trigger):
    ...
    message. Timezone is any timezone UnivBot takes elsewhere; the best choices
    ...
    if pytz:
        timezone = UnivBot.tools.get_timezone(bot.db, bot.config, tz,
...
def create_reminder(bot, trigger, duration, message, tz):
    ...
    if duration >= 60:
        ...
        timef = UnivBot.tools.format_time(bot.db, bot.config, tz, trigger.nick,
