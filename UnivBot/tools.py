...
class UnivBotMemory(dict):

    """A simple thread-safe dict implementation.

    *Availability: 4.0; available as ``UnivBot.UnivBotMemory`` in 3.1.0 - 3.2.0*
...
class UnivBotMemoryWithDefault(defaultdict):
    """Same as UnivBotMemory, but subclasses from collections.defaultdict."""
    def __init__(self, *args):
